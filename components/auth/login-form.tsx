  ...
  return (
        <Card className="w-ful">
          <CardHeader className="space-y-1 pb-4 lg:pb-6">
            <CardTitle className="text-xl lg:text-2xl font-bold text-center lg:text-left">Sign In</CardTitle>
            <CardDescription className="text-sm lg:text-base text-center lg:text-left">
          ...
          <CardContent className="space-y-4 lg:space-y-6 px-4 lg:px-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-12 h-11 lg:h-12 text-base"
                    required
                  />
                  <Button
                    type="button"
            ...
            <div className="text-center text-xs lg:text-sm text-gray-600 mt-4 lg:mt-6 px-2">
              <p className="leading-relaxed">
                Need an account?{" "}
                <span className="block sm:inline mt-1 sm:mt-0">Contact your administrator to get access.</span>
              </p>
            </div>
          </CardContent>
        </Card>
